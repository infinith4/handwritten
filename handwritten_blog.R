...
for(i in 1:m){
  ...
  if(i==16||i==32||i==64||i==128){
    z<-array(restorevec,dim=c(28,28)) #28*28
    z<-z[,28:1] ##right side up #
...
l=5*5
for(i in 1:l){
  z<-array(eigen(S)$vectors[,i],dim=c(28,28)) #28*28
  z<-z[,28:1] ##right side up #
  image(1:28,1:28,z,main=i,col=cus_col(256))
}
